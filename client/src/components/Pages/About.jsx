    ...
    <div>
        ...
        <div className="mt-3">
            <p > Welcome to Socialites - A social media website. </p>
                <ul>
                    <li> Users first have to register themselves to the site using their email 
                         and verify that email or they can quickly login using Google. </li>
                    ...
                    <li> Users can also chat with other users in real time, either personally or by creating 
                         a room and sharing that roomID. </li>
                    <li> Users also have an option to leave chat groups and delete their messages from chats </li>
                    <li> Users can also share images on chats </li>
                    <li> Search option and many features have been added to provide good user experience. </li>
                    <li> For a quick look, Users can also take a tour of the website by logging in as a guest. </li>
                    <li> They can also check the "remember me" option to login once for a period of time. </li>
                    ...
                    <li> Users can see a pie chart based on the number of reactions and comments on their posts. </li>
                </ul>
        </div>
